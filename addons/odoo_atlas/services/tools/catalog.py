...
PARTNER = ModelSpec(
    ...
    fields=(
        "id", "display_name", "name", "ref", "email", "phone", "mobile", "city",
        "country_id", "vat", "function", "parent_id", "is_company", "customer_rank",
        "supplier_rank", "category_id", "user_id", "company_id", "create_date",
        "write_date",
    ),
...
PRODUCT = ModelSpec(
    ...
    label="Products",
    fields=(
        "id", "display_name", "name", "default_code", "barcode", "categ_id",
        "list_price", "standard_price", "type", "uom_id", "active", "company_id",
        "write_date",
    ),
...
SALE_ORDER = ModelSpec(
    ...
    fields=(
        ...
        "amount_untaxed", "currency_id", "user_id", "team_id", "client_order_ref",
...
SALE_ORDER_LINE = ModelSpec(
    ...
    fields=(
        "id", "order_id", "product_id", "name", "product_uom_qty", "qty_delivered",
        "price_unit", "price_subtotal", "price_total", "state", "salesman_id",
        "order_partner_id", "company_id",
    ),
    date_field="create_date",
...
PURCHASE_ORDER = ModelSpec(
    ...
    fields=(
        "id", "name", "partner_id", "date_order", "state", "amount_total",
        "amount_untaxed", "currency_id", "user_id", "partner_ref", "company_id",
        "write_date",
    ),
    date_field="date_order",
    measures=("amount_total", "amount_untaxed"),
...
INVOICE = ModelSpec(
    ...
    fields=(
        ...
        "move_type", "payment_state", "amount_total", "amount_residual",
        "currency_id", "ref", "company_id", "write_date",
    ),
...
STOCK_QUANT = ModelSpec(
    ...
    fields=(
        ...
        "reserved_quantity", "available_quantity", "company_id", "write_date",
    ),
    date_field="write_date",
...
CRM_LEAD = ModelSpec(
    ...
    fields=(
        ...
        "stage_id", "user_id", "team_id", "expected_revenue", "probability",
        "date_deadline", "active", "company_id", "create_date", "write_date",
    ),
    date_field="create_date",
...
def available_models(env):
    ...
    return [
        ...
        if spec.model in env and env[spec.model].has_access("read")
    ]
